...
function center(x,y){
    draw.circle(centerRadius).fill('yellow').move(x,y);
}
...
function flower(x,y){
    ...
    petal(x+9,y);
    let petal1 = draw.circle(petalRadius).fill('pink').move(x+30,y-40);
    let petal2 = draw.circle(petalRadius).fill('pink').move(x+10,y-75);
    let petal3 = draw.circle(petalRadius).fill('pink').move(x-35,y-80);
    let petal4 = draw.circle(petalRadius).fill('pink').move(x-60,y-40);
    let petal5 = draw.circle(petalRadius).fill('pink').move(x-50,y);
